...
Page({
  ...
  showmodel: function (e) {
    ...
    if (this.data.currentTab == '0') {
      ...
      wx.request({
        url: 'https://www.360yipiao.com/tty/little/ebill/list?page=1&psize=300&inOut=出&orgCat=国股&priceAsc=false',
        data: '',
        header: {},
        method: 'GET',
        dataType: 'json',
      ...
      wx.request({
        url: 'https://www.360yipiao.com/tty/little/ebill/list?page=1&psize=300&inOut=出&orgCat=城商&priceAsc=false',
        data: '',
        header: {},
        method: 'GET',
        dataType: 'json',
      ...
      wx.request({
        url: 'https://www.360yipiao.com/tty/little/ebill/list?page=1&psize=300&inOut=出&orgCat=农商&priceAsc=false',
        data: '',
        header: {},
        method: 'GET',
        dataType: 'json',
